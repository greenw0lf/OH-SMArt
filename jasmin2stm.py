...
parser.add_argument('-vl', help = 'Use it to convert the Flemish part of JASMIN instead of \
                    the Dutch part', default='./whisper2ctm/output_dir/')
